...
class AdminRestaurantControllerTest extends AbstractControllerTest {
    ...
    void updateDuplicate() throws Exception {
        Restaurant invalid = new Restaurant(RestaurantTestData.REST_ID1, RestaurantTestData.rest2.getName(),
                                            RestaurantTestData.rest2.getAddress());
        perform(MockMvcRequestBuilders.put(API_URL + "/" + RestaurantTestData.REST_ID1)
                                      .contentType(MediaType.APPLICATION_JSON)
                                      .content(JsonUtil.writeValue(invalid)))
            .andDo(print())
    ...
    void createDuplicate() throws Exception {
        Restaurant invalid = new Restaurant(null, RestaurantTestData.rest1.getName(),
                                            RestaurantTestData.rest1.getAddress());
        perform(MockMvcRequestBuilders.post(API_URL)
                                      .contentType(MediaType.APPLICATION_JSON)
                                      .content(JsonUtil.writeValue(invalid)))
            .andDo(print())
